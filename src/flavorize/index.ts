...
const all = (regex: string, replaceWith: string[]) =>
  custom('', regex, replaceWith);
const adjective = (regex: string, replaceWith: string[]) =>
  custom('adj.', regex, replaceWith);
const verb = (regex: string, replaceWith: string[]) =>
  custom('v.', regex, replaceWith);
